...
class TSPDatasetDGL(Dataset):
    def __init__(self, name):
        ...
        data_dir = f'{root}/benchmarking-gnns/benchmarking_gnns/data/TSP'
        self.train = TSP(data_dir=data_dir, split='train', num_neighbors=25, max_samples=10000) 
        self.val = TSP(data_dir=data_dir, split='val', num_neighbors=25, max_samples=1000)
        self.test = TSP(data_dir=data_dir, split='test', num_neighbors=25, max_samples=1000)
