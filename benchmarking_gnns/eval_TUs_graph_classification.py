...
def eval_pipeline(MODEL_NAME, DATASET_NAME, params, net_params, write_file_name):
    ...
    try:
        for split_number in range(10):
            ...
            testset = dataset.test[split_number]
            ...
            with tqdm(range(params['epochs'])) as t:
                for epoch in t:
                    ...
                    t.set_postfix(time=time.time()-start, test_acc=epoch_test_acc)  
...
def main():    
    ...
    eval_pipeline(MODEL_NAME, DATASET_NAME, params, net_params, write_file_name)
